...
function get_shopall_category_commericial_places($id)
{
  //get main CodeIgniter object
       $ci =& get_instance();
       ...
       $session_id = $ci->session->userdata("id");
       if ($session_id) {
  $query="SELECT * FROM category_commericial_places WHERE id=".$id." And user_id!=".$session_id;
       }
       else{
        $query="SELECT * FROM category_commericial_places WHERE id=".$id;
       }
...
function get_shopall_category_residential_places($id)
{
  //get main CodeIgniter object
       $ci =& get_instance();
       ...
       $session_id = $ci->session->userdata("id");
       if ($session_id) {
  $query="SELECT * FROM category_residential_places WHERE id=".$id." And user_id!=".$session_id;
       }
       else{
        $query="SELECT * FROM category_residential_places WHERE id=".$id;
       }
...
function get_shopall_category_land_plot($id)
{
  //get main CodeIgniter object
       $ci =& get_instance();
       ...
       $session_id = $ci->session->userdata("id");
       if ($session_id) {
  $query="SELECT * FROM category_land_plot WHERE id=".$id." And user_id!=".$session_id;
       }
       else{
        $query="SELECT * FROM category_land_plot WHERE id=".$id;
       }
...
function get_all_category_commericial($id)
{
  //get main CodeIgniter object
       $ci =& get_instance();
...
function get_all_category_residensial($id)
{
  //get main CodeIgniter object
       $ci =& get_instance();
...
function get_all_category_land_plot($id)
{
  //get main CodeIgniter object
       $ci =& get_instance();
...
{ 
    ...
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_job WHERE pay_type!=3 AND user_id !='.$session_id.'
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_tuitions WHERE pay_type!=3 AND user_id !='.$session_id.'
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_commericial_places WHERE  pay_type!=3 AND user_id !='.$session_id.'
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_residential_places WHERE  pay_type!=3 AND user_id !='.$session_id.'
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_land_plot WHERE  pay_type!=3 AND user_id !='.$session_id.'
      ...
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_job WHERE pay_type!=3
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_tuitions WHERE pay_type!=3
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_commericial_places WHERE pay_type!=3
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_residential_places WHERE pay_type!=3
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_land_plot WHERE pay_type!=3
      ) as  custam  WHERE address like "%'.$location.'%"  ';
     }
...
{ 
    ...
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_job WHERE user_id !='.$session_id.'
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_tuitions WHERE user_id !='.$session_id.'
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_commericial_places WHERE user_id !='.$session_id.'
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_residential_places WHERE user_id !='.$session_id.'
    UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_land_plot WHERE user_id !='.$session_id.'
    ) as  custam  WHERE address like "%'.$location.'%"';
     }
     else{
      $query= 'SELECT * from (SELECT title,id,category_id,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_reusable_parts 
      ...
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_job
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_tuitions
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_commericial_places
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_residential_places
      UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_land_plot
      ) as  custam  WHERE address like "%'.$location.'%"  ';
     }
...
function get_seller_product($id)
{
  ...
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,Tuitions_loction,NULL,Education_Type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_tuitions WHERE pay_type!=3 And user_id = $id UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,filter,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_commericial_places WHERE pay_type!=3 And user_id = $id UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,filter,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_residential_places WHERE pay_type!=3 And user_id = $id UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,filter,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_land_plot WHERE pay_type!=3 And user_id = $id ";
...
$session_id = $ci->session->userdata("id");
if($session_id){
  $query="select * from (SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_reusable_parts WHERE pay_type = 1 AND active_status = 0 AND user_id != $session_id UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type  FROM category_job  WHERE pay_type = 1 AND active_status = 0 AND user_id != $session_id UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_internships WHERE pay_type = 1 AND active_status = 0 AND user_id != $session_id UNION 
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_tuitions WHERE pay_type = 1 AND active_status = 0 AND user_id != $session_id UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_commericial_places WHERE pay_type = 1 AND active_status = 0 AND user_id != $session_id UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_residential_places WHERE pay_type = 1 AND active_status = 0 AND user_id != $session_id UNION
  ...
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at FROM category_internships WHERE pay_type = 1  AND active_status = 0 UNION 
...
function get_all_boost_admin()
{
  ...
  $query="select * from (SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_reusable_parts WHERE pay_type = 1  UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type  ,created_at,verified_admin FROM category_job  WHERE pay_type = 1  UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,NULL,cover_img,images_2,images_3,images_4,images_5 ,pay_type  ,created_at,verified_admin FROM category_internships WHERE pay_type = 1 UNION 
 
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type   ,created_at,verified_admin FROM category_tuitions WHERE pay_type = 1 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type  ,created_at,verified_admin  FROM category_commericial_places WHERE pay_type = 1 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type  ,created_at,verified_admin FROM category_residential_places WHERE pay_type = 1 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type  ,created_at,verified_admin FROM category_land_plot WHERE pay_type = 1)s ORDER BY created_at DESC ";
...
function get_all_normal()
{
  ...
  $query="select * from (SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_reusable_parts WHERE pay_type = 0 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_job  WHERE pay_type = 0 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,NULL,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_internships WHERE pay_type = 0  UNION 
 
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_tuitions WHERE pay_type = 0 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin  FROM category_commericial_places WHERE pay_type = 0 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_residential_places WHERE pay_type = 0 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_land_plot WHERE pay_type = 0 ) s ORDER BY created_at DESC";
...
$rowperpage=4;
  ...
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type  FROM category_job   UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_internships UNION 
...
function get_product_by_subid($subcategory_id,$category_id)
{
  ...
  //get main CodeIgniter object
       ...
       if($location){
        if($session_id){
          $query="SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_reusable_parts WHERE   pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id AND user_id != $session_id AND address = '$location' UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin  FROM category_job  WHERE  pay_type!=3 AND Job_type	 = $subcategory_id AND category_id = $category_id AND user_id != $session_id AND address = '$location' UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_internships WHERE  pay_type!=3 AND Job_type	 = $subcategory_id AND category_id = $category_id AND user_id != $session_id AND address = '$location' UNION 
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_tuitions WHERE  pay_type!=3 AND Education_type = $subcategory_id AND category_id = $category_id AND user_id != $session_id AND address = '$location' UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_residential_places WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id AND user_id != $session_id AND address = '$location' UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_commericial_places WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id AND user_id != $session_id AND address = '$location' UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_land_plot WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id AND user_id != $session_id AND address = '$location'  ORDER BY CASE WHEN (pay_type = 1 OR verified_admin = yes OR verified_product = 1) THEN 0 ELSE 1 END, pay_type DESC";;
               }
            else{
        $query="SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_reusable_parts WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id AND address = '$location' UNION
                SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin  FROM category_job  WHERE  pay_type!=3 AND Job_type	 = $subcategory_id AND category_id = $category_id AND address = '$location' UNION
                SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_internships WHERE  pay_type!=3 AND Job_type	 = $subcategory_id AND category_id = $category_id AND address = '$location' UNION 
                SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_tuitions WHERE  pay_type!=3 AND Education_type = $subcategory_id AND category_id = $category_id AND address = '$location' UNION
                SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_residential_places WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id AND address = '$location' UNION
                SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_commericial_places WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id AND address = '$location' UNION
                SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_land_plot WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id AND address = '$location'  ORDER BY CASE WHEN (pay_type = 1 OR verified_admin = 'yes' OR verified_product = 1) THEN 0 ELSE 1 END, pay_type DESC";
       ...
       if($session_id){
  $query="SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_reusable_parts WHERE  pay_type!=3 AND subcategory_id = $subcategory_id  AND category_id = $category_id AND user_id != $session_id UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin  FROM category_job  WHERE  pay_type!=3 AND Job_type	 = $subcategory_id  AND category_id = $category_id AND user_id != $session_id UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_internships WHERE  pay_type!=3 AND Job_type	 = $subcategory_id  AND category_id = $category_id AND user_id != $session_id UNION 
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_tuitions WHERE pay_type!=3 AND Education_type = $subcategory_id  AND category_id = $category_id AND user_id != $session_id UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_commericial_places WHERE  pay_type!=3 AND subcategory_id = $subcategory_id  AND category_id = $category_id AND user_id != $session_id UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_residential_places WHERE  pay_type!=3 AND subcategory_id = $subcategory_id  AND category_id = $category_id AND user_id != $session_id UNION
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_land_plot WHERE  pay_type!=3 AND subcategory_id = $subcategory_id  AND category_id = $category_id AND user_id != $session_id ORDER BY CASE WHEN (pay_type = 1 OR verified_admin = 'yes' OR verified_product = 1) THEN 0 ELSE 1 END, pay_type DESC";
     }
       else{
        $query="SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_reusable_parts WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id UNION
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin  FROM category_job  WHERE pay_type!=3 AND Job_type	 = $subcategory_id AND category_id = $category_id UNION
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_internships WHERE pay_type!=3 AND Job_type	 = $subcategory_id AND category_id = $category_id UNION 
       
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_tuitions WHERE pay_type!=3 AND Education_type = $subcategory_id AND category_id = $category_id UNION
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_commericial_places WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id UNION
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_residential_places WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id UNION
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type,verified_admin FROM category_land_plot WHERE  pay_type!=3 AND subcategory_id = $subcategory_id AND category_id = $category_id ORDER BY CASE WHEN (pay_type = 1 OR verified_admin = 'yes' OR verified_product = 1) THEN 0 ELSE 1 END, pay_type DESC";
...
$rowperpage=4;
  ...
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_tuitions WHERE pay_type = 2 )s ORDER BY id DESC LIMIT $row , $rowperpage";
...
function get_all_donate()
{
  //get main CodeIgniter object
       ...
       $session_id = $ci->session->userdata("id");
       if($session_id){
  $query="select * from (SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_reusable_parts WHERE pay_type = 2 AND active_status = 0 AND user_id != $session_id UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type  FROM category_job  WHERE pay_type = 2  AND active_status = 0 AND user_id	!= $session_id UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,NULL,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_internships WHERE pay_type = 2  AND active_status = 0 AND user_id	 != $session_id UNION 
 
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_tuitions WHERE pay_type = 2  AND active_status = 0 AND user_id != $session_id )s LIMIT 0,4";
       }
       else{
        $query="select * from (SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_reusable_parts WHERE pay_type = 2  AND active_status = 0 UNION
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type  FROM category_job  WHERE pay_type = 2  AND active_status = 0  UNION
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,NULL,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_internships WHERE pay_type = 2  AND active_status = 0 UNION 
       
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_tuitions WHERE pay_type = 2 AND active_status = 0 )s ORDER BY id DESC LIMIT 0,4" ;
       }
  $category_data = $ci->db->query($query);        
...
function get_all_donate_admin()
{
  ...
  $query="select * from (SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_reusable_parts WHERE pay_type = 2  UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_job  WHERE pay_type = 2   UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,NULL,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_internships WHERE pay_type = 2  UNION 
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_tuitions WHERE pay_type = 2 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_commericial_places WHERE pay_type = 2 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_residential_places WHERE pay_type = 2 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_land_plot WHERE pay_type = 2 )s ORDER BY created_at DESC";
...
function get_all_active_Product()
{
  ...
  $query="select * from (SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type, created_at,verified_admin FROM category_reusable_parts WHERE active_status = 0  UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_job  WHERE active_status = 0    UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,NULL,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_internships WHERE active_status = 0   UNION 
 
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_tuitions WHERE active_status = 0 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_commericial_places WHERE active_status = 0 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_residential_places WHERE active_status = 0 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_land_plot WHERE active_status = 0)s ORDER BY created_at DESC";
...
function get_all_deactive_Product()
{
  ...
  $query="select * from (SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_reusable_parts WHERE active_status = 1  UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_job  WHERE active_status = 1   UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,NULL,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_internships WHERE active_status = 1  UNION 
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_tuitions WHERE active_status = 1 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_commericial_places WHERE active_status = 1 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_residential_places WHERE active_status = 1 UNION
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,filter,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type ,created_at,verified_admin FROM category_land_plot WHERE active_status = 1 )s ORDER BY id DESC";
...
UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_commericial_places WHERE pay_type=2 And user_id !='.$session_id.'
UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_residential_places WHERE pay_type=2 And user_id !='.$session_id.'
UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_land_plot WHERE pay_type=2 And user_id !='.$session_id.') as  custam  WHERE address like "%'.$location.'%"';
  ...
  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_commericial_places WHERE pay_type=2
  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_residential_places WHERE pay_type=2
  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,cover_img ,verified_product ,address from category_land_plot WHERE pay_type=2
  ) as  custam  WHERE address like "%'.$location.'%"  ';
 }
...
function get_all_location_boost($location)
{
   ...
   $session_id = $ci->session->userdata("id");
 if ($session_id) {
$query= 'SELECT * from (SELECT title,id,category_id,subcategory_id ,user_id ,price,cover_img ,verified_product ,pay_type,address from category_reusable_parts WHERE pay_type!=3 And pay_type=1 And user_id !='.$session_id.'
                  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price,cover_img ,verified_product ,pay_type,address from category_internships WHERE  pay_type!=3 And pay_type =1 And user_id !='.$session_id.'
                  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_job WHERE pay_type!=3 And pay_type =1 And user_id !='.$session_id.'
                  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_tuitions WHERE  pay_type!=3 And pay_type =1 And user_id !='.$session_id.'
                  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_commericial_places WHERE  pay_type!=3 And pay_type =1 And user_id !='.$session_id.'
                  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_residential_places WHERE  pay_type!=3 And pay_type =1 And user_id !='.$session_id.'
                  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_land_plot WHERE  pay_type!=3 And  pay_type =1 And user_id !='.$session_id.'
) as  custam  WHERE address like "%'.$location.'%"';
 }
 else{
  $query= 'SELECT * from (SELECT title,id,category_id,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_reusable_parts WHERE pay_type!=3 And pay_type =1
  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_internships WHERE pay_type!=3 And pay_type =1
  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_job WHERE pay_type!=3 And pay_type =1
  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_tuitions WHERE pay_type!=3 And pay_type =1
  UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_commericial_places WHERE  pay_type!=3 And pay_type =1
UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_residential_places WHERE  pay_type!=3 And pay_type =1
UNION SELECT title,id,category_id ,subcategory_id ,user_id ,price ,cover_img ,verified_product ,pay_type,address from category_land_plot WHERE  pay_type!=3 And pay_type =1
  ) as  custam  WHERE address like "%'.$location.'%"  ';
 }
