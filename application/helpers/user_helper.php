...
if($session_id){
  ...
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_tuitions WHERE pay_type = 1 AND active_status = 0 AND user_id != $session_id)s ORDER BY id DESC LIMIT 0,4 ";
}
else{
  ...
  SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_tuitions WHERE pay_type = 1 AND active_status = 0) s ORDER BY id DESC LIMIT 0,4   ";
 }
  $category_data = $ci->db->query($query);        
  ...
  //get main CodeIgniter object
       ...
       if($location){
        if($session_id){
          ...
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_tuitions WHERE  pay_type!=3 AND Education_type = $subcategory_id AND user_id != $session_id AND address = '$location'";
               }
               else{
                ...
                SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Education_Type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_tuitions WHERE  pay_type!=3 AND Education_type = $subcategory_id AND address = '$location'";
               }
       }else{
