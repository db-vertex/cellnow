...
function get_product_by_subid($subcategory_id,$category_id)
{
  ...
  //get main CodeIgniter object
       ...
       if($location){
        if($session_id){
          ...
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_internships WHERE  pay_type!=3 AND Job_type	 = $subcategory_id AND category_id = $category_id AND user_id != $session_id AND address = '$location' UNION 
  ...
  $query="SELECT id, user_id,title,category_id,subcategory_id,verified_product,brand,postal_code,bill,Warrenty,type,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_reusable_parts WHERE  pay_type!=3 AND subcategory_id = $subcategory_id  AND category_id = $category_id AND user_id != $session_id UNION
          ...
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_internships WHERE  pay_type!=3 AND Job_type	 = $subcategory_id  AND category_id = $category_id AND user_id != $session_id UNION 
          ...
          SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,NULL,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_residential_places WHERE  pay_type!=3 AND subcategory_id = $subcategory_id  AND category_id = $category_id AND user_id != $session_id UNION
        ...
        SELECT id, user_id,title,category_id,subcategory_id,verified_product,NULL,postal_code,NULL,Job_type,NULL,address,Description,price,cover_img,images_2,images_3,images_4,images_5 ,pay_type FROM category_internships WHERE pay_type!=3 AND Job_type	 = $subcategory_id AND category_id = $category_id UNION 
