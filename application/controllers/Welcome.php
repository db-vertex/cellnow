...
<svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chevron-left"
	...
	<div class="va-card va-card_category"> <a class=" border-0"   
		<p style="text-align:center;" class="my-auto pouler_Categories " ';
			...
			$sub .= '>
		<img class="btn-change common_selector sub_category sub_new' . $value->subcategory_id . '"  data-sub-id=" '.$value->id.'" data-cat-id=" '.$value->category_id.'" src="https://dbvertex.com/celnow/uploads/shopcategory/' . $value->icon . '" alt="">
