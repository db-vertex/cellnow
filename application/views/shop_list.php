...
<table id="example3" class="table table-bordered table-striped">
        ...
        <tbody>
          ...
          <?php foreach ($shop as $value) {?>
              ...
              <input type="checkbox" name="status" <?php if($value->admin_approval =="1"){ echo "checked"; } ?> onclick ="togglestatus(<?php echo $value->id ;?>)" id="status" >
...
<script type="text/javascript">
  ...
  var status = 1;
  swal({
        title: "Are you want to sure verifed shop ????",
        text: "",
        type: "warning",
        showCancelButton: true,
        confirmButtonClass: "btn-danger",
