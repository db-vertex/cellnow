 ...
 new nicEditor({buttonList : ['fontSize','bold','italic','underline','strikeThrough','subscript','superscript','html']}).panelInstance('about_us_text');*/
  ...
  //]]>*/
         ...
         <div class="box box-primary" style="padding-right: 389px;">
           ...
           <?php echo form_open('admin/add_meta'); ?> 


 
              <div class="form-group">
                          <label for="about_us_text">Description</label>
                          <textarea class="form-control" name="meta_text"  id="meta_text" rows="10"><?php if(!empty($meta->meta)){ echo $meta->meta ; } ?></textarea>
                           <div style="color:red;">
