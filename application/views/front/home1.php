              ...
              foreach ($category as $key => $cat) {
                ...
                ?>
                 <li class="" id="" onMouseOut="hide_sidebar()">
                      <a <?php if($cat->id==4){?>style="background:#d1fae5" <?php } ?> class="btn shadow  rounded-pill" href="<?php echo base_url();?>welcome/fillter_product/4" role="button"><img class="rounded-circle me-1"  src="<?php echo base_url();?>uploads/category/<?php echo $cat->icon;?>" alt=""> &nbsp &nbsp <?php echo $cat->category; ?> </a>
